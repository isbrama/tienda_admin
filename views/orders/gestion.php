<div class="content-container ">
  <div class="wrapper table-responsive-lg">
    <h2><i class="fa fa-th-list" aria-hidden="true"></i> Gestion des commandes</h2>
    ...
    <table id="tableGestion">
      ...
      <tr>
        ...
        <td>
          ...
          <a href="<?=BASE_URL?>orders/delete&id=<?=$order->id ?>"><i class="fas fa-trash-alt btn btn-danger"></i></a>
        </td>
      </tr>
    <?php endwhile; ?>
    </tbody>
